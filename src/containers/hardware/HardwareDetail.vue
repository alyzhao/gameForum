            ...
            <div class="game">
                ...
                <div class="intro">
                    <div class="game-detail">
                        <span class="tit">核心数量：六核</span>
                    </div>
                    <div class="game-detail">
                        <span class="tit">接口类型：LGA 1151</span>
                    </div>
                    <div class="game-detail">
                        <span class="tit">三级缓存：9M</span>
                    </div>
                    <div class="game-detail">
                        <span class="tit">工作功率：65W</span>
                    </div>
                    <div class="game-detail">
                        <span class="tit"><span>参考价格: </span>￥14999</span>
                    </div>
                </div>
            </div>
        </div>
